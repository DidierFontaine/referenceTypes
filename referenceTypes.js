...
colour.push(5)
console.log(colour)
colour.push({greeting: "Hi ik ben een object"})
console.log(colour)
console.log(colour[5].greeting);
...
console.log("energy levels van eerste kat: ", catBreeds[catBreeds.length-3].energy_level)
